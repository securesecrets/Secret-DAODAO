...
pub enum Snip721RolesReceiveMsg {
...
impl HandleCallback for Snip721RolesReceiveMsg {
...
pub fn receive_nft_msg(
    ...
    let msg = Snip721RolesReceiveMsg::ReceiveNft {
        sender,
        token_id,
        msg,
    };
...
pub fn batch_receive_nft_msg(
    ...
    let msg = Snip721RolesReceiveMsg::BatchReceiveNft {
        sender,
        from,
        token_ids,
        msg,
