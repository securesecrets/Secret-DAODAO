...
use crate::{expiration::Expiration, token::Metadata};
...
pub struct Snip721Contract<InstantiateExt, ExecuteExt, QueryExt, MetadataExt>
where
    MetadataExt: DeserializeOwned + Serialize,
{
    ...
    metadata_type: PhantomData<MetadataExt>,

    pub token_extension_info: Keymap<'static, String, MetadataExt, Json>,
    pub pub_metadata: Keymap<'static, String, Metadata, Json>,
    pub priv_metadata: Keymap<'static, String, Metadata, Json>,
    pub query_auth: Item<'static, Contract>,
}
...
{
    const fn new(
        token_extension_key: &'static str,
        pub_metadata_key: &'static str,
        priv_metadata_key: &'static str,
        query_auth_key: &'static str,
    ) -> Self {
        Self {
            ...
            token_extension_info: Keymap::new(token_extension_key.as_bytes()),
            pub_metadata: Keymap::new(pub_metadata_key.as_bytes()),
            priv_metadata: Keymap::new(priv_metadata_key.as_bytes()),
            query_auth: Item::new(query_auth_key.as_bytes()),
        }
    }
}

impl<InstantiateExt, ExecuteExt, QueryExt, MetadataExt> Default
    for Snip721Contract<InstantiateExt, ExecuteExt, QueryExt, MetadataExt>
where
    MetadataExt: DeserializeOwned + Serialize,
{
    fn default() -> Self {
