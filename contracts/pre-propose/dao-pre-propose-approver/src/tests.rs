...
//                 admin: Some(Admin::CoreModule {}),
//                 funds: vec![],
//                 label: "approver module maka naka shaka".to_string(),
//             },
//         },
//         close_proposal_on_execution_failure: false,
//         veto: None,
...
//     println!("Dao code hash : {}", core_info.code_hash);
...
//             proposal_single_approver_addr.clone(),
//             &dps::msg::QueryMsg::ProposalCreationPolicy {},
//         )
//         .unwrap();
...
//         )
//         .unwrap();
//     println!("proposals ::::::  {:?}",props.proposals.len());
