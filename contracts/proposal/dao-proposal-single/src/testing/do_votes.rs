...
// use cosmwasm_std::{coins, Addr, Coin, ContractInfo, Uint128};
...
//     let core_info = setup_governance(&mut app, instantiate, Some(initial_balances));

//     let governance_modules: Vec<ProposalModule> = app
//         .wrap()
//         .query_wasm_smart(
//             core_info.clone().code_hash,
//             core_info.clone().address.to_string(),
