...
pub fn instantiate_query_auth(app: &mut App) -> ContractInfo {
...
pub fn instantiate_snip721_roles(app: &mut App, sender: &str) -> (ContractInfo, u64, ContractInfo) {
    ...
    let snip721_roles_info = app
        .instantiate_contract(
            ...
            &snip721_roles::msg::InstantiateMsg {
    ...
    (
        snip721_roles_info,
        snip721_roles_contract_instantiate_info.code_id,
        query_auth,
    )
}
